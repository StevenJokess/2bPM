...
然后把用户的数据贩卖。\ `13 <https://zhuanlan.zhihu.com/p/37181872>`__
...
996、上厕所需计时\ `12 <https://www.zhihu.com/question/426967823>`__

平台奶头乐用户
^^^^^^^^^^^^^^

短视频平台上，信息要么是碎片化的，要么是娱乐化的。\ `14 <https://www.zhihu.com/question/351872270/answer/911748530>`__

开源？还是剥削？
^^^^^^^^^^^^^^^^

各大厂开源背后暗藏对制定规则（起先的一套开源代码有极大的学习成本）的野心。而对于之后的开源开发者，却沦为廉价的、随时可以替换的劳动力和大厂所谓拥抱“自由开源”的宣传工具人。
