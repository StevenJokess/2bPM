...
行测题一般由以下几种题型组成：\ `1 <https://zhuanlan.zhihu.com/p/83786056>`__
...
增长量与增长率：增长量 = 现期量 - 基期量 增长率 = 增长量 / 基期量 \*
100%
...
第一步：写推理公式，(1) W → X (2) -T → -S (3) T → -X，X → -T (4) Y且Z →
W

第二步：写逆否公式，原命题成立则逆否命题必然成立，(1’) -X → -W (2’) S →
T (3’) X → -T，T → -X (4’) -W→ -Y或-Z
...
2. 是否一笔画
3. 布尔运算规律：两个图形叠加得第三个图形
4. 旋转、对称、平移运动规律
5. 数量规律：点（交点数、端点数）、线（线数、曲线数、直线数）、面（封闭域数）、角（角数）、素（每种图形的数量，图形种数）
6. 接触规律：点接触、面接触
...
常用面试题 `2 <https://zhuanlan.zhihu.com/p/23664545>`__
--------------------------------------------------------
...
6.  考察面试者在以往的工作中对自己的产品是否有深入思考
    是否有找到用户痛点,核心用户群,是否满足核心用户的需求
7.  考察面试者对硬件的了解
8.  考察笔试是否是面试者的真实成绩,同时,面试的双向交流比笔试的单向交流更能了解面试者的产品素质
9.  考察面试者是否对自己常使用的产品有过思考
10. 考察面试者对UI,交互,特色功能的掌握与理解
11. 考察面试者对UI的理解(可能由于纯银的产品小清新居多,所以比较看重UI)
12. 考察面试者的信息搜集能力,从侧面了解面试者在互联网行业所处层次
    (如,连dribble都不去的设计师,设计水平不会有多高)
13. 考察面试者是否对自己常使用的产品有过思考
14. 考察面试者的数据分析能力
15. 考察面试者的项目沟通与协作能力
...
2. 某一天，百度的用户检索量下降5%，请分析可能的原因。（百度）\ `3 <https://www.zhihu.com/question/382522778/answer/1811915139>`__

产品运营类
~~~~~~~~~~

1. 产品假设今天你开了一家经营生鲜品类的淘宝店，你怎么获取第一批用户，并能够运营起来？（阿里巴巴）
2. 如果你是一名广告主，给你2千万在中国为“炉石传说”（暴雪公司出品的一款魔兽世界题材的卡牌类移动网游）做广告宣传，你打算怎么花？（百度商业产品）\ `3 <https://www.zhihu.com/question/382522778/answer/1811915139>`__
