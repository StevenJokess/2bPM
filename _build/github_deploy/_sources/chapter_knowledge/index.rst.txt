...
.. figure:: ../img/whole_process.png

   整个产品实现的流程和生命周期\ `1 <https://ke.qidianla.com/courses/pmcamp?channel=bbs>`__

.. figure:: ../img/whole_project.png

   完整项目的角色

.. figure:: ../img/PM_work.png

   产品经理的工作职能\ `6 <https://zhuanlan.zhihu.com/p/340058145>`__

-  领域专家：用无人机看书，农业专家对二月份的树该有大致的样子是清楚的。甲方翻译成任务交给数据科学家（乙方）去提高。
-  数据科学家：关心实际业务问题。不断开发新领域。
-  AI专家：不仅能用，精度性能。领域做深。\ `4 <https://www.bilibili.com/video/BV1J54y187f9/?p=2&spm_id_from=pageDriver>`__
...
2.自然语言处理（NLP）：自然语言理解（NLU）、自然语言生成（NLG）、知识图谱\ `2 <http://www.mysecretrainbow.com/ai/18035.html>`__\ 等
3.智能语音：语音识别、语音合成、声纹识别
4.智能软硬件：芯片\ `5 <https://mbb.eet-china.com/tech>`__\ 、智能软硬件项目流程；
