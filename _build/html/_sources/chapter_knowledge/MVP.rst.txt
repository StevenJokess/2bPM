...
.. figure:: ../img/MVP_build.png

   MVP建造\ `3 <https://www.yuque.com/wuxinghua/01/uqgdgxs>`__
...
MVP必备模块 `3 <https://www.yuque.com/wuxinghua/01/uqgdgxs>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
MMP(Minimum Marketable Product)是什么？ `4 <http://www.shinescrum.com/news_and_events/mvp>`__
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
1. 抢占市场先机
2. 及早获取真实用户的反馈
3. 依据第一版本的市场反馈，决策后续迭代的演进，从而减少不必要的需求开发，减少浪费。
...
AI产品的MVP `5 <http://www.woshipm.com/pmd/2817456.html>`__
-----------------------------------------------------------

low-hanging fruit
~~~~~~~~~~~~~~~~~

对于AI MVP来说，从最容易实现的目标（low-hanging
fruit）开始做起或许是不错的选择。\ `6 <https://www.itsiwei.com/26937.html>`__
