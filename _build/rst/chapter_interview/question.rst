...
我叫蔡舒起，年龄23，2020届的山西大学金融学专业的毕业生，获得三好学生学业奖学金，拥有会计、证券、基金从业证书，毕业论文是用Python的Statsmodel库里的VAR模型完成的《中美股市的联动性分析》。20年基本自学完了《动手学深度学习》并用PyTorch动手复现了GAN:raw-latex:`\DCGAN`，复现PyTorch
DJL等深度移动端框架的demo，并自行总结了AI产品经理的工作内容和技能要求，用Docker部署成书。现求职一份金融AI产品岗位。
